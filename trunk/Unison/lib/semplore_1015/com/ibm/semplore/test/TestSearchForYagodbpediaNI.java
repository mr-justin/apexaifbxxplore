 ...
 * </copyright>
 *
 * $Id: TestSearchForYagodbpediaNI.java,v 1.5 2007/05/26 04:15:04 lql Exp $
 */
 ...
 *
 */
public class TestSearchForYagodbpediaNI extends TestSearch
{    
...
//                showRelFacets();    
                ...
                while (!quit) {
                  ...
                  searchInstance(schemaFactory.createCatRelGraph()
                    		.add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
                    				.addComponentCategory(schemaFactory.createCategory("http://dbpedia.org/resource/Category___Documentary_films"))
              ...
              searchInstance(schemaFactory.createCatRelGraph()
                      ...
                      searchInstance(schemaFactory.createCatRelGraph()
                      .add(schemaFactory.createKeywordCategory("ibm"))
                      .add(schemaFactory.createUniversalCategory())
                      ...
                      searchInstance(schemaFactory.createCatRelGraph()
                              .add(schemaFactory.createKeywordCategory("volcano"))
                    ...
                    searchInstance(schemaFactory.createCatRelGraph()
                      ...
                      searchInstance(schemaFactory.createCatRelGraph()
                      .add(schemaFactory.createKeywordCategory("AIDS"))
                  	  .add(schemaFactory.createUniversalCategory())
           			  .add(schemaFactory.createRelation("http://dbpedia.org/property/director")
           						  , 0, 1)
                          ,1);
                      ...
                      searchInstance(schemaFactory.createCatRelGraph()
                      	  .add(schemaFactory.createKeywordCategory("mp3"))
                   		  .add(schemaFactory.createKeywordCategory("gnu"))
                        ...
                        searchInstance(schemaFactory.createCatRelGraph()
                        .add(schemaFactory.createKeywordCategory("hurricane"))
                    	  .add(schemaFactory.createKeywordCategory("2006"))
                	...
                	//query set 4                	
                        ...
                        searchInstance(schemaFactory.createCatRelGraph()
                    		  .add(schemaFactory.createKeywordCategory("xbox"))
                    	...
                    	//find directors who have directed "romantic" films starring Best Actor Academy Award Winners and Best Actress Academy Award Winners and also "war" films    
                  	searchInstance(schemaFactory.createCatRelGraph()
                    ...
                    //find artist who have albums of "hip hop", "rock", "pop", and "folk"
                      ...
                      searchInstance(schemaFactory.createCatRelGraph()
              		  .add(schemaFactory.createUniversalCategory())
            		  .add(schemaFactory.createKeywordCategory("audio"))
            		  .add(schemaFactory.createKeywordCategory("image"))
            		  .add(schemaFactory.createKeywordCategory("video"))
       				  .add(schemaFactory.createRelation("http://dbpedia.org/property/developer")
       						  , 1, 0)
       				  .add(schemaFactory.createRelation("http://dbpedia.org/property/developer")
       						  , 2, 0)
                    ...
                    //find manufacturers that have "sport car","economy car", and "luxury car" products
                      searchInstance(schemaFactory.createCatRelGraph()
              		  .add(schemaFactory.createUniversalCategory())
            		  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
            				  .addComponentCategory(schemaFactory.createKeywordCategory("sport"))
            				  .addComponentCategory(schemaFactory.createKeywordCategory("car")))
            		  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
            				  .addComponentCategory(schemaFactory.createKeywordCategory("economy"))
            				  .addComponentCategory(schemaFactory.createKeywordCategory("car")))
            		  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
            				  .addComponentCategory(schemaFactory.createKeywordCategory("luxury"))
            				  .addComponentCategory(schemaFactory.createKeywordCategory("car")))
       				  .add(schemaFactory.createRelation("http://dbpedia.org/property/manufacturer")
       						  , 1, 0)
       				  .add(schemaFactory.createRelation("http://dbpedia.org/property/manufacturer")
       						  , 2, 0)
       				  .add(schemaFactory.createRelation("http://dbpedia.org/property/manufacturer")
...
//                  find teams of some "football" leagues which played in season "2005" and has an "English" manager
               		searchInstance(schemaFactory.createCatRelGraph()
...
//                    Find "pc" games of "strategy" genre by "game" developer and "American" publisher
                      searchInstance(schemaFactory.createCatRelGraph()
                      		  .add(schemaFactory.createKeywordCategory("pc"))
                    ...
                    //find films and tvs that have "attorney", "doctor", and "president" as main characters 
                    searchInstance(schemaFactory.createCatRelGraph()
                    .add(schemaFactory.createUniversalCategory())//0 film 
            		  .add(schemaFactory.createUniversalCategory())//1 star
          		  .add(schemaFactory.createKeywordCategory("attorney"))
            		  .add(schemaFactory.createUniversalCategory())//3 star
          		  .add(schemaFactory.createKeywordCategory("doctor"))
            		  .add(schemaFactory.createUniversalCategory())//5 star
          		  .add(schemaFactory.createKeywordCategory("president"))
     				  .add(schemaFactory.createRelation("http://dbpedia.org/property/star")
     						  , 0, 1)
     				  .add(schemaFactory.createRelation("http://dbpedia.org/property/portray")
     						  , 2, 1)
     				  .add(schemaFactory.createRelation("http://dbpedia.org/property/star")
     						  , 0, 3)
     				  .add(schemaFactory.createRelation("http://dbpedia.org/property/portray")
...
//                    //find films that have actors reaching "Academy Award", "Emmy Award", "Golden Globe Award", and "Cannes Film Festival"
//                      searchInstance(schemaFactory.createCatRelGraph()
//              		  .add(schemaFactory.createUniversalCategory())
//            		  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
//            				  .addComponentCategory(schemaFactory.createKeywordCategory("Academy"))
//            				  .addComponentCategory(schemaFactory.createKeywordCategory("Award")))
//            		  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
//            				  .addComponentCategory(schemaFactory.createKeywordCategory("Golden"))
//            				  .addComponentCategory(schemaFactory.createKeywordCategory("Globe"))
//            				  .addComponentCategory(schemaFactory.createKeywordCategory("Award")))
//            		  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
//            				  .addComponentCategory(schemaFactory.createKeywordCategory("Emmy"))
//            				  .addComponentCategory(schemaFactory.createKeywordCategory("Award")))
//            		  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
//            				  .addComponentCategory(schemaFactory.createKeywordCategory("Cannes"))
//            				  .addComponentCategory(schemaFactory.createKeywordCategory("Film"))
//            				  .addComponentCategory(schemaFactory.createKeywordCategory("Festival")))
//       				  .add(schemaFactory.createRelation("http://dbpedia.org/property/star")
//       						  , 0, 1)
//       				  .add(schemaFactory.createRelation("http://dbpedia.org/property/star")
//       						  , 0, 2)
