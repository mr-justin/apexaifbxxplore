 ...
 *
 */
public class DataPropertySuper implements Feature {
	...
	public Object get(Object object, Structure structure) {
		try {
			...
			Set entities = property.getSuperDataProperties(ontology.ontology);
//			if (entities.size()>0) {System.out.print("sup");}															
			return entities;
		} catch (Exception e) {
			return null;
		}
