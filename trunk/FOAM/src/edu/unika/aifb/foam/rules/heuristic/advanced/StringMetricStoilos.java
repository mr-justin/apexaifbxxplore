...
//import org.ivml.alimo.SubStringSets;

import edu.unika.aifb.foam.result.ResultTable;
import edu.unika.aifb.foam.rules.heuristic.Heuristic;

public class StringMetricStoilos implements Heuristic{
	
	private static final long serialVersionUID = 1L;
//	private SubStringSets subStringSets = new SubStringSets();
	...
	public double get(Object object1, Object object2) {
		...
		double newscore = score(word1,word2)/2+0.5;
		return newscore;
	}

	/**
	 * Copied from SubStringSets.java
