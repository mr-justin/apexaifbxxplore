...
public class SyntacticStemmed implements Heuristic {
	...
	public double get(Object object1, Object object2) {
		...
		word1 = stem(word1);
		word2 = stem(word2);
		return syntactic.get(word1,word2);
	}
	
	  /**
	   * The stemmer-functions are imported.
	   * This method can only process one word at a time.
	   *
	   * @param str word
	   * @return stemmed word
	   */
