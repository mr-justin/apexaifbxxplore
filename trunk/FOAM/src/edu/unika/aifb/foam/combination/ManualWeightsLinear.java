...
public class ManualWeightsLinear implements Combination {
	...
	public ManualWeightsLinear(int totalT) {
		...
		weights[2] = 1.0;			//superDir
		weights[3] = 1.0;			//subDir
		weights[4] = 1.0;			//domDir
		weights[5] = 1.0;			//domDir
		weights[6] = 1.0;			//ranDir
		weights[7] = 1.0;			//instDir
		weights[8] = -1.0;			//sub and sup contra
		weights[9] = -1.0;			//sub and sup contra

		weights[10] = 1.0;		//domDir
		weights[11] = 1.0;		//super
		weights[12] = 1.0;		//sub
		weights[13] = 1.0;		//propinst

		weights[14] = 1.0;		//domDir
		weights[15] = 1.0;		//ranDir
		weights[16] = 1.0;		//super
		weights[17] = 1.0;		//sub
		weights[18] = 1.0;		//propinst
		
		weights[19] = 1.0;		//typeDir
		weights[20] = 1.0;		//predobj
		weights[21] = 1.0;		//predobj
		weights[22] = 1.0;		//subjpred
