...
//import org.xmedia.accessknow.sesame.AdapterEnvironment;
...
//		IConnectionProvider provider = new ConnectionProvider();
//
...
//		try {
//			session = factory.openSession(provider.getConnection(), m_onto);
...
////		return (String)((StatelessSession)SessionFactory.getInstance().getCurrentSession()).getConnection().getConfiguration().get(ExploreEnvironment.BASE_ADAPTATION_ONTOLOGY_URI);
////	}
//	
...
////		TODO are rules possible in SESAME? -> don't know
//	}
//	
