...
public class GetDataTypesNodeAction extends Action {
	...
	public GetDataTypesNodeAction(VisualItem item, GraphViewer graphViewer) {
	...
	public void run() {
		...
		if(m_graphControl.getDatatypes(m_item))
