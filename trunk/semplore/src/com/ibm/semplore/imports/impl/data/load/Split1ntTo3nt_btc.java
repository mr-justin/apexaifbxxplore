...
//					outh.println(String.format("%d\tTYPE\t%d\t%d", hash[j], Md5_BloomFilter_64bit.HASH_TYPE, Md5_BloomFilter_64bit.HASH_TYPE_RELATION));
//				}
//				else if (j==2 && tripletype == Util4NT.CATEGORY) {
