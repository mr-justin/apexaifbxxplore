 ...
 * </copyright>
 *
 * $Id: TestSearchForIBM.java,v 1.2 2008/09/01 09:53:14 lql Exp $
 */
 ...
 *
 */
public class TestSearchForIBM extends TestSearch
{    
                    ...
                    for (int jj=2; jj<3; jj++) {
                        ...
                        searchInstance(schemaFactory.createCatRelGraph()
                        		.add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
                        				.addComponentCategory(schemaFactory.createKeywordCategory("use")))
//                        				.addComponentCategory(schemaFactory.createEnumerationCategory()
//                        						.addInstanceElement(schemaFactory.createInstance("<http://umrr.dyn.webahead.ibm.com/2007/sys/use>"))))
//                      		  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
...
//                      		  .add(schemaFactory.createRelation("<http://dbpedia.org/property/starring>"), 1, 0)
                         ,0);

//                        searchInstance(schemaFactory.createCatRelGraph()
//                        		  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
//                        				  .addComponentCategory(schemaFactory.createKeywordCategory("king of the pop")))
////                        				  .addComponentCategory(schemaFactory.createCategory("<http://dbpedia.org/resource/Category:American_film_actors>")))
//                        				  .add(schemaFactory.createUniversalCategory())
//                        				  .add(schemaFactory.createRelation("<http://dbpedia.org/property/artist>"), 1, 0)
//                           ,0);
//                    	                    	
//                        searchInstance(schemaFactory.createCatRelGraph()
//                      		  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
//                      				  .addComponentCategory(schemaFactory.createKeywordCategory("academy award")))
//              				  .add(schemaFactory.createKeywordCategory("star wars"))
//               				  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
//               						  .addComponentCategory(schemaFactory.createCategory("<http://dbpedia.org/resource/Category:Jewish_American_film_directors>")))
//               				  .add(schemaFactory.createRelation("<http://dbpedia.org/property/starring>"), 0, 1)
//                      		  .add(schemaFactory.createRelation("<http://dbpedia.org/property/director>"), 0, 2)
//                         ,2);
                  	                    	
//                        searchInstance(schemaFactory.createCatRelGraph()
//                        		  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
//                        				  .addComponentCategory(schemaFactory.createKeywordCategory("action film")))
//                        		  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
//                        				  .addComponentCategory(schemaFactory.createKeywordCategory("martial")))
//                 				  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
////                 						  .addComponentCategory(schemaFactory.createCategory("<http://dbpedia.org/resource/Category:Hong_Kong_film_directors>")))
//                 						  .addComponentCategory(schemaFactory.createEnumerationCategory()
//                 								  .addInstanceElement(schemaFactory.createInstance("<http://dbpedia.org/resource/Lo_Wei>"))))
//                 				  .add(schemaFactory.createRelation("<http://dbpedia.org/property/starring>"), 0, 1)
//                        		  .add(schemaFactory.createRelation("<http://dbpedia.org/property/director>"), 0, 2)
//                           ,0);
//                    	                    	
//                        searchInstance(schemaFactory.createCatRelGraph()
//                        		  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
//                         				  .addComponentCategory(schemaFactory.createUniversalCategory()))
//                         		  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
//                      				  .addComponentCategory(schemaFactory.createKeywordCategory("apollo 13")))
//                         		  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
//                      				  .addComponentCategory(schemaFactory.createKeywordCategory("forrest gump")))
...
//                        searchInstance(schemaFactory.createCatRelGraph()
//                       		  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
//                        				  .addComponentCategory(schemaFactory.createCategory("<http://dbpedia.org/resource/Category:Chinese_actors>")))
//                    		  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
//                     				  .addComponentCategory(schemaFactory.createUniversalCategory()))
//                     		  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
//                    				  .addComponentCategory(schemaFactory.createCategory("<http://dbpedia.org/resource/Category:American_film_directors>")))
...
//                        searchInstance(schemaFactory.createCatRelGraph()
//                      		  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
//                        				  .addComponentCategory(schemaFactory.createKeywordCategory("action")))
//                       		  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
//                    				  .addComponentCategory(schemaFactory.createKeywordCategory("martial")))
//                       		  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
//                      				  .addComponentCategory(schemaFactory.createCategory("<http://dbpedia.org/resource/Category:Hong_Kong_film_directors>")))
...
//                         				  .addComponentCategory(schemaFactory.createUniversalCategory()))
//                        		  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
//                        				  .addComponentCategory(schemaFactory.createKeywordCategory("Turing Award")))
//                				  .add(schemaFactory.createRelation("<http://dbpedia.org/property/workInstitution>")
//                						  , 1, 0)
//                           ,0);
//                        
//                        searchInstance(schemaFactory.createCatRelGraph()
//                      		  .add(schemaFactory.createCompoundCategory(CompoundCategory.TYPE_AND)
//                      				  .addComponentCategory(schemaFactory.createCategory("<http://dbpedia.org/resource/Category:Living_people>"))
//                      				  .addComponentCategory(schemaFactory.createKeywordCategory("world wide web")))
//                         ,0);
