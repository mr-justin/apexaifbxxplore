...
public class Md5_BloomFilter_128bit {
	public static String HASH_URI = "1936434897019030473;3069097663303534468";
	public static String HASH_TYPE = "8736192962590431624;-95230424018221932";
	public static String HASH_TYPE_INSTANCE = "2683022113649976747;-7302756725272101313";
	public static String HASH_TYPE_RELATION = "-816450795805011627;467244173468883851";
	public static String HASH_TYPE_CATEGORY = "-5772458573049287457;-932182635515939689";
	public static String HASH_UNIVERSAL_CATEGORY_URI = "-2437815354339154748;2781463960749071549";
	public static String HASH_UNIVERSAL_RELATION_URI = "-561082763347132051;-4734823314135488255";
	...
	/**
	 * 
	 * @return low 64bit ID in a long type. You should use it after calling the function set() or calling the function genMd5Code(),
	...
	/**
	 * 
	 * @return high 64bit ID in a long type. You should use it after calling the function set() or calling the function genMd5Code(),
	 * or you will get an unexpected answer.
	 */
	...
	/**
	 * 
	 * @return 64bit ID in a long type. You should use it after calling the function set(), or you will
	...
	public static void main(String args[]) throws NoSuchAlgorithmException {
		String[] ss = {"URI", "TYPE", "TYPE_INSTANCE", "TYPE_RELATION", "TYPE_CATEGORY", "<TOP_Category>", "UNIVERSAL_RELATION"};
		for (int i=0; i<ss.length; i++) {
			System.out.println(HashID.encode2(ss[i]));
		}
	}
}
