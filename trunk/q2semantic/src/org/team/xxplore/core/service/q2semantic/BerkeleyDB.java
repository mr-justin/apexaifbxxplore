...
/**
 * Using BerkeleyDB to implement a disk-based HashTable
 * @author kaifengxu
 *
 */
public class BerkeleyDB 
{
	/* fyi http://cllovelf.blog.chinajavaworld.com/entry.jspa?id=2824 */
	private Environment myDbEnvironment = null;
	private Database myDatabase = null;
	private Cursor myCursor = null;
	private boolean dup;//allow duplicated or not
	private int buffer =  10000000, count =0;//refresh the db when buffer is full
	...
	/**
	 * flush the data in memorty to disk
	 * @throws Exception
	 */
	...
	{
		if(++count%buffer==0)//refresh if buffer is full
			flush();
