...
//		if ((descr1 != null)&&(descr2 != null)) {
			...
			if ((descr1 instanceof DataCardinality)&&(descr2 instanceof DataCardinality)) {	//DataCardinality
				...
				Integer min1 = new Integer(comp1.MINIMUM);
				Integer max1 = new Integer(comp1.MAXIMUM);
				...
				Integer min2 = new Integer(comp2.MINIMUM);
				Integer max2 = new Integer(comp2.MAXIMUM);	
