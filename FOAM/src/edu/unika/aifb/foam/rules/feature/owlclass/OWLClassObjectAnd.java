 ...
 *
 */
public class OWLClassObjectAnd implements Feature {
...
//			if (concept.getURI().equalsIgnoreCase("http://www.w3.org/TR/2003/PR-owl-guide-20031209/wine#WineDescriptor")) {
//				System.out.println("!!");
//			}
			...
			while (iter.hasNext()) {
				...
				if (next instanceof ObjectAnd) {
					specialDescriptions.add(next);
				}
			}
//			if (specialDescriptions.size()>0) {System.out.print("and");}						
