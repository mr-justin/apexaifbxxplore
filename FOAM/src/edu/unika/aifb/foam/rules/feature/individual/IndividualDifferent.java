 ...
 *
 */
public class IndividualDifferent implements Feature {
	...
	public Object get(Object object, Structure structure) {
		try {
			...
			Set entities = individual.getDifferentIndividuals(ontology.ontology);
//			if (entities.size()>0) {System.out.print("diff");}																											
			return entities;
		} catch (Exception e) {
			return null;
		}
