...
//	temp file
	public static String GRAPHEDGEPOOL = "-graphEdgePool", 	// id(filename denoting predicate(ObjectProperty)) -> 
															// format: subject(Concept), score, predicate(ObjectProperty), score, object(Concept), score.
						OBJPROPPOOL = "-objpropPool", 		// id(filename denoting predicate(ObjectProperty)) -> 
															// format: subject(Individual), object(Individual).   
						conceptCountObj = "-conceptCount.obj", // format: concept, sizeOfIndividuals
						resultFile = "-result.txt";			// SizeOfIndividual | SizeOfPropertyAssertion | 
															// format: predicate(ObjectProperty), id   
