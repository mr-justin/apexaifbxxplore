 ...
 */
public class ExtendedRadialTreeLayout extends TreeLayout {
     ...
     */
    public ExtendedRadialTreeLayout(String group) {
        super(group);
     ...
     * in the layout.
     */
    public ExtendedRadialTreeLayout(String group, int radius) {
        this(group);
        m_radiusInc = radius;
        m_autoScale = false;
    }
    ...
    public void run(double frac) {
        ...
        //System.out.println("the m_group num in Layout: " + m_vis.getGroup(m_group).getTupleCount());
        ...
        //System.out.println("the nodesnum in Grpah: " + g.getNodeCount());
    }
    ...
    private void calcAngularBounds(NodeItem r) {
        ...
        while ( iter.hasNext() ) {
            ...
            if ( n == p ) break;
                    ...
                    if (((NodeItem)n).isVisible()) {//only consider visible node
    ...
    private double calcAngularWidth(NodeItem n, int d) {
        ...
        if (n.isVisible() && n.isExpanded() && n.getChildCount() > 0 ) {
    ...
    protected void layout(NodeItem n, double r, double theta1, double theta2) {
        ...
        while ( n.isVisible() && childIter != null && childIter.hasNext() ) {
            NodeItem c = (NodeItem)childIter.next();
            ...
            if (  c.isExpanded() && c.getChildCount()>0 ) {     
            	...
            	//layout(c, r+m_radiusInc, 0, MathLib.TWO_PI);
