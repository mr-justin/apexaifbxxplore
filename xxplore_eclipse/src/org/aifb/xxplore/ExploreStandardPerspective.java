...
public class ExploreStandardPerspective implements IPerspectiveFactory{

	public static final String ID = "org.aifb.xxplore.explorestandardperspective";
	...
	private void defineLayout(IPageLayout layout) {
		...
		topLeft.addView(FactResultView.ID);
