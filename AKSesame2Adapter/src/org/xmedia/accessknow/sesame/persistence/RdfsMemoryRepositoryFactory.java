...
public class RdfsMemoryRepositoryFactory {
	...
	public static RepositoryConfig createRepository(Repository ownerRepository, String theRepositoryId) throws RepositoryConfigException, RepositoryException {
		...
		graph.add(delegate, vf.createURI("http://www.openrdf.org/config/sail#sailType"), vf.createLiteral("openrdf:MemoryStore"));
		graph.add(delegate, vf.createURI("http://www.openrdf.org/config/sail/memory#persist"), vf.createLiteral(true));
