...
//        	System.out.println("CobjStream length: "+CobjStream.getLen());
////			DocStream tmp = (DocStream)CobjStream.clone();
////			tmp.init();
////			for (int j=0; j<tmp.getLen(); j++,tmp.next()) {
//////				if (tmp.doc()>=838565)
////					System.out.print(tmp.doc()+" ");
////			}
////			System.out.println();
//        	e.printStackTrace();
//			//for debug
