 ...
 * </copyright>
 *
 * $Id: SegmentTermDocs.java,v 1.2 2007/04/18 06:55:34 lql Exp $
 */
...
/**
 * It is changed to extends StreamReader for Reservoir Sampling.
 * 
 * @author liu Qiaoling
 *
 */
class SegmentTermDocs implements TermDocs, DocStream {
  ...
  protected TermInfo termInfo;
	...
	/* (non-Javadoc)
	 * @see com.ibm.semplore.ds.StreamReader#getLen()
	 */
  	public int getLen() {
  		return df;
  	}
...
//		      while (target > skipDoc) {
		      int skipRealCount = skipCount * skipInterval;
		      while (idx > skipRealCount) {
		        lastSkipDoc = skipDoc;
		        lastFreqPointer = freqPointer;
		        lastProxPointer = proxPointer;
